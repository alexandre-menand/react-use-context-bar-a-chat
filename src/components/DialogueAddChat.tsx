  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-1 bg-blue-500 transition-all cursor-pointer duration-75 ease-in hover:scale-105 text-sm text-white p-2 px-5 rounded-2xl"
      >
        <RiAddLine />
        Ajouter un Chat
      </button>
